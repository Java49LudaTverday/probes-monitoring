...
class AdminConsoleControllerTest {
	...
	private static final String URL_UPDATE_RANGE = "http://localhost:8090" + UrlConstants.UPDATE_RANGE;
	private static final String URL_UPDATE_EMAILS = "http://localhost:8090" + UrlConstants.UPDATE_EMAILS;
	private static final Long SENSOR_ID_NOT_FOUND = 111l;
	@Autowired
	MockMvc mockMvc;
	@MockBean
	...
	void updateEmailsSensorNotFound() throws Exception {
		when(adminService.updateSensorEmails(sensorEmailsNotFound))
